...
const handleAppLinkSelected = (appLink: AppLink) => {
  ...
  switch (appLink.type) {
    case  APP_LINK_TYPE_ENUM.PRODUCT_CATEGORY_LIST:
      ...
      //反显
      detailSelectDialog.value.id = getUrlNumberValue('id', 'http://127.0.0.1' + activeAppLink.value.path || undefined)
      break
    default:
      break
  }
...
const handleGroupSelected = (group: string) => {
  ...
  if (titleRef) {
    ...
    scrollToGroupBtn(titleRef.value)
  }
}
// 分组滚动条
